...
const MainWrapper = () => {
  return (
    <div className='flex border-none bg-custom-main-gradient min-h-[895px] gap-[57px] rounded-xl items-center justify-center shadow-custom-main px-4 xl:flex-row  flex-col overflow-auto'>
